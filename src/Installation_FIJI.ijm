...
PathSUM = getDirectory('macros') + File.separator();
PathSUM += 'StartupMacros.fiji.ijm';

// Retrieve the path of the folder containing the installation macro.
PathFolderInput = File.directory;					
